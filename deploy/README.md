...
# ============================================================================
# deploy/agent_engine_config.yaml
# ============================================================================
"""
# Vertex AI Agent Engine Configuration for MarketReportAgent
# Update the values below with your project-specific information

# Project Configuration
project_id: "your-project-id"                    # Your GCP project ID
location: "us-central1"                          # Region for deployment
agent_engine_id: "market-report-agent"           # Unique agent identifier

# Agent Configuration
agent:
  display_name: "Market Report Agent"
  ...
  session_config:
    session_ttl: "3600s"                         # Session timeout (1 hour)
    enable_session_persistence: true
    
  # Scaling Configuration
  scaling:
    min_instances: 1                             # Minimum instances running
  ...
  environment:
    GOOGLE_GENAI_USE_VERTEXAI: "TRUE"
    GOOGLE_CLOUD_PROJECT: "your-project-id"      # Same as project_id above
    GOOGLE_CLOUD_LOCATION: "us-central1"         # Same as location above
...
security:
  service_account: "default"                     # Or specify custom service account
